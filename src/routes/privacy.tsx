...
const scopedCss = `
  #privacy-root a{color:${L.primary};}
  #privacy-root a:focus-visible{outline:2px solid ${L.primary};outline-offset:3px;border-radius:10px;}
  #privacy-root li::marker{color:${L.primary};}
`;
...
function PrivacyPage() {
  return (
    <div id="privacy-root" className="min-h-screen" style={rootStyle}>
