...
const scopedCss = `
  ...
  #simular-oral-root .lib-reveal{animation:simOralReveal 0.5s cubic-bezier(0.22,1,0.36,1) both;}
  ...
  @keyframes simOralReveal{from{opacity:0;transform:translateY(12px);}to{opacity:1;transform:none;}}
